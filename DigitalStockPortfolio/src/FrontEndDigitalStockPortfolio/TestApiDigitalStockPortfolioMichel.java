...
//		System.out.println("Account-Saldo: " + api.getAccountBalance());
		...
		/*
		 * apiTest.buyShare("TSLA"); apiTest.buyShare("TSLA"); apiTest.buyShare("TSLA");
		 * apiTest.buyShare("TSLA"); apiTest.buyShare("TSLA");
		 * 
		 * apiTest.definedLimiteBuy("TSLA", 347);
		 * 
		 * 
		 * 
		 * apiTest.sellShare("TSLA"); apiTest.sellShare("TSLA");
		 * apiTest.sellShare("TSLA"); apiTest.sellShare("TSLA");
		 * 
		 * apiTest.definedLimiteSell("TSLA", 347);
		 * 
		 * apiTest.sleep(20); apiTest.calculateWinOrLoss();
		 * 
		 * apiTest.sleep(300); apiTest.calculateWinOrLoss();
		 * 
		 */
	}
	...
	public void getMarketPrice(String isinNo) {
		...
		System.out.println("---------------------------------------------------");
		System.out.println("Marktpreis der " + isinNo + " betraegt: " + api.getMarketPrice(isinNo)); // Ausgabe isinNo
																										// noch testen
		System.out.println("---------------------------------------------------");
	}
